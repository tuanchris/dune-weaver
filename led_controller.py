...
class MockLEDController(BaseLEDController):
    ...
    def __init__(self, led_count=47):
        ...
        self.is_on = False
        print(f"[MOCK] Initialized LED controller with {led_count} LEDs")
    
    def set_color(self, color):
        self.current_color = color
        print(f"[MOCK] Color set to: RGB{color}")
        return True
    ...
    def start_animation(self, animation_type):
        ...
        def mock_animation():
            print(f"[MOCK] Animation {animation_type} is running...")
    ...
    def turn_on(self):
        self.is_on = True
        print("[MOCK] LED strip turned on")
        return True
...
class RaspberryLEDController(BaseLEDController):
    ...
    def __init__(self, led_count=47, led_pin=18, led_freq_hz=800000, led_dma=10, led_brightness=255, led_channel=0):
        try:
            ...
            print(f"Initialized LED controller with {led_count} LEDs")
        except ImportError:
