            ...
            ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                                ...
                                RowLayout {
                                    ...
                                    Label {
                                        text: isSerialConnected ?
                                              (selectedPort ? `Bağlı: ${selectedPort}` : "Bağlandı") :
                                              (selectedPort || "Port seçilmedi")
                            ...
                            ModernControlButton {
                                ...
                                Layout.preferredHeight: 40
                                text: isSerialConnected ? "Bağlantıyı Kes" : "Bağlan"
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Label {
                            text: "Otomatik Oynatma Ayarları"
                            font.pixelSize: 14
                            font.bold: true
                            color: Components.ThemeManager.textPrimary
                        }
                        ...
                        RowLayout {
                            ...
                            Label {
                                text: "Başlangıçta otomatik oynat:"
                                font.pixelSize: 12
                                color: Components.ThemeManager.textSecondary
                                Layout.fillWidth: true
                            }
